            ...
            while True:
                ...
                if data.hex().startswith("1200"):
                    ...
                    if response:
                        ...
                        if inPuTMsG.startswith('Subscribe'):
...
def run_flask():
    app.run(host='0.0.0.0', port=11500, debug=False, use_reloader=False)

async def MaiiiinE():
    global loop, key, iv, region
    Uid , Pw = '4356284268','Nm_R66OB_BY_SPIDEERIO_GAMING_5WEK3'
